...
insert Usuario values (null,'Omar','Espinoza', '99887766', '123456', '993217610', 'oaemdl@gmail.com');
...
insert CinePelicula values
    ...
    ( 10,  8, 1, '16:15 / 19:30 / 21:45' ), 
	( 10, 11, 2, '15:00 / 17:30 / 20:00 / 22:15' ), 
	( 10, 15, 3, '17:00 / 20:15 / 22:30' ), 
	( 10, 16, 4, '14:00 / 16:00 / 18:00' ); 
...
insert CineTarifa values
	...
	( 10, 'Lunes y Miércoles', 5.50 ),
	( 10, 'Martes', 4.50 ),
	( 10, 'Jueves y Viernes', 7.50 ),
	( 10, 'Sábados, Domingos y Feriados', 10.00 ),
	( 10, 'Adulto mayor y niños de 2 hasta 8 años (Jueves a Domingos)', 6.00 ),
	( 10, '3D - Lunes, Martes y Miércoles', 9.00 ),
	( 10, '3D - Jueves a Domingo', 13.00 ),
	( 10, 'Adulto mayor y niños de 2 hasta 8 años (Sábados y Domingos)', 10.50 );
...
create procedure sp_getPeliculass()
  select *, getGenerosDetalle(Generos) 'Geneross', DateLong(FechaEstreno) 'FechaEstrenoss' from Pelicula;
...
call sp_getCines()
call sp_getCine(10)
call sp_getCineTarifas(10)
call sp_getCinePeliculas(10)
